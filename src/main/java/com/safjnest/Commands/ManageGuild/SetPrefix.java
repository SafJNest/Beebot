...
public class SetPrefix extends Command{
    ...
    protected void execute(CommandEvent event) {
        ...
        String query = "INSERT INTO guild_settings(guild_id, prefix)" + "VALUES('" + event.getGuild().getId() + "','" + event.getArgs() +"') ON CONFLICT(guild_id) DO UPDATE SET prefix = '" + event.getArgs() + "' RETURNING guild_id;";
