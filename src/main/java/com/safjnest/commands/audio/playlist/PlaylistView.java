...
public class PlaylistView extends SlashCommand{
    private static final int pageSize = 10;
    public PlaylistView(String father) {
    ...
    public static EmbedBuilder getTracksEmbed(QueryRecord playlist, Member member, int page) {
        QueryCollection tracks = BotDB.getPlaylistTracks(playlist.getAsInt("id"), pageSize, page);
