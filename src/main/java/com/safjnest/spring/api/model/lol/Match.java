...
public class Match {
    ...
    @Column(name = "bans", columnDefinition = "LONGTEXT")
    private String bans;
    ...
    public Match(String gameId, Integer leagueShard, Integer gameType, String bans, LocalDateTime timeStart, LocalDateTime timeEnd, String patch) {
        this.gameId = gameId;
