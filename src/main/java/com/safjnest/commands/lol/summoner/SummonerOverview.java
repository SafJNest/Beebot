...
public class SummonerOverview extends SlashCommand {
  ...
  @Override
    ...
    LeagueMessage.send(event.getHook(), userId, summoner, summoner.getPUUID(), new LeagueMessageParameter(LeagueMessageType.OVERVIEW));
	}
  ...
  @Override
    ...
    LeagueMessage.send(event, userId, summoner, summoner.getPUUID(), new LeagueMessageParameter(LeagueMessageType.OVERVIEW));
	}
