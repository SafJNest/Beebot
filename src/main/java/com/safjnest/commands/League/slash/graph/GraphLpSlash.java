...
public class GraphLpSlash extends SlashCommand {
	...
	protected void execute(SlashCommandEvent event) {
        ...
        // String dateStart = event.getOption("date-start").getAsString();
        // String dateEnd = event.getOption("date-end").getAsString();

        // long timeStart = SafJNest.parseDate(dateStart);
        // long timeEnd = SafJNest.parseDate(dateEnd);
    ...
    // public static EmbemdBuilder createEmbed(no.stelar7.api.r4j.pojo.lol.summoner.Summoner s , long timeStart, long timeEnd) {
    ...
    //     System.out.println(tierDivisionMapReformed.toString());
    //     if (splitMonths(result)) {
    ...
    //     QueryResult result = DatabaseHandler.getSummonerData(s.getAccountId(), timeStart, timeEnd);
    ...
    //     List<Integer> values = getValues(result, tierDivisionMapReformed);
    ...
    //     for (Map.Entry<Integer, Integer> entry : tierDivisionMapReformed.entrySet()) {
