...
public class CustomizeSound extends SlashCommand {
    ...
    protected void execute(SlashCommandEvent event) {
        ...
        Sound sound = SoundCache.getSoundByString(fileName, event.getGuild(), event.getUser());
        ...
        event.replyEmbeds(eb.build()).setComponents(SoundEmbed.getSoundButton(sound.getId())).queue();
